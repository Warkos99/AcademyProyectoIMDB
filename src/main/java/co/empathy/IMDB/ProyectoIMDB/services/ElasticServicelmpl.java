...
import co.empathy.IMDB.ProyectoIMDB.repositories.ElasticEngine;
import co.empathy.IMDB.ProyectoIMDB.utils.IMDbData;
import co.empathy.IMDB.ProyectoIMDB.utils.IMDbReader;
...
public class ElasticServicelmpl implements ElasticService{

    private final ElasticEngine elasticEngine;

    private final IMDbData data = new IMDbData();

    private static final Logger LOGGER = LoggerFactory.getLogger(ElasticServicelmpl.class);
